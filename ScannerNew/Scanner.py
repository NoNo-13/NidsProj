        ...
        for op in rule.options:
            ...
            if (op.keyword == "content"):
                ...
                if("|" in op.settings):
                    ...
                    #matches any combination of one or more hexadecimal digits (0-9, a-f, A-F) or whitespace characters.
                    # The + symbol indicates that the character class must occur one or more times.
                    #end with "|" character
